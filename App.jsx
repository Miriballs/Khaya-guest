...
const ROOMS = [
  { id: "savanna",       name: "Savanna ensuite", type: "private", desc: "Double bed, en-suite bathroom with tub/shower combo, desk.", priceLow: 49, priceHigh: 54 },
  { id: "jungle",        name: "Jungle ensuite",  type: "private", desc: "Double bed, en-suite bathroom with tub/shower combo, door to garden, desk.", priceLow: 49, priceHigh: 54 },
  { id: "ocean",         name: "Ocean twin",      type: "private", desc: "Small twin room with 2 single beds or king, shared bathroom.", priceLow: 41, priceHigh: 44 },
  { id: "sky",           name: "Sky twin",        type: "private", desc: "Larger twin room with 2 single beds or king, shared bathroom & desk. Note: by the kitchen, so more susceptible to noise.", priceLow: 41, priceHigh: 44 },
  { id: "joannas_cabin", name: "Joanna's Cabin", type: "private", desc: "Cabin in the front yard. Double bed, outdoor bathroom & desk.", priceLow: 44, priceHigh: 48 },
  { id: "cove",          name: "Cove ensuite",    type: "private", desc: "Small private room with double bed, en-suite bathroom, separate entrance from the rest of the house for added privacy.", priceLow: 44, priceHigh: 48 },
  { id: "zazus_cabin",   name: "Zazu's Cabin",   type: "private", desc: "Cabin in a private corner of the property. Double bed, outdoor bathroom & desk.", priceLow: 44, priceHigh: 48 },
  { id: "sunrise",       name: "Sunrise ensuite", type: "private", desc: "Largest room. Double bed, en-suite bathroom with separate tub and shower.", priceLow: 52, priceHigh: 56 },
  { id: "dorm8",         name: "Dorm 8-bed",     type: "dorm",    beds: 8, desc: "Bed in the 8-bed shared dorm. Shared bathroom.", priceLow: 17, priceHigh: 20 },
  { id: "dorm4",         name: "Dorm 4-bed",     type: "dorm",    beds: 4, desc: "Bed in the 4-bed shared dorm. Shared bathroom.", priceLow: 17, priceHigh: 20 },
  { id: "dorm2",         name: "Dorm 2-bed",     type: "dorm",    beds: 2, desc: "Bed in the 2-bed shared dorm. Shared bathroom.", priceLow: 17, priceHigh: 20 },
  { id: "hippobus",      name: "Hippobus",       type: "special", desc: "The converted bus — a Khaya original.", priceLow: 25, priceHigh: 30 },
